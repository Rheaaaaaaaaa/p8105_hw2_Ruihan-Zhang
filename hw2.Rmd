...
```
The total weight of trash collected by Professor Trash Wheel is `r sum(Professor_Trash_Data$weight)`. The total number of sports balls collected by Mr. Trash Wheel in 2020 was `r sum(Mr.Trash_data$sports_balls)`
